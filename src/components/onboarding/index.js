...
export default class Joy extends React.Component {
  state = {
    ...
    steps: [
      ...
      {
        content:
          "You can click on the dropdowns, to create, edit or delete your goals",
        placement: "right",
        styles: {
          options: {
            width: 300
      ...
      {
        content:
          "Ah! And don't forget to use these buttons to start, complete and prioritize your goals",
        placement: "right",
        styles: {
          options: {
            width: 300
  ...
  handleJoyrideCallback = data => {
    ...
    switch (status) {
      ...
      case "running":
        ...
        if (index >= 3) {
          //if user goes after step two (set short term goal), also avoid starting again
