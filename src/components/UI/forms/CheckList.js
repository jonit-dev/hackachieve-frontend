...
class CheckList extends Component {
  ...
  componentWillMount() {
    if (this.props.item)
      this.props.initialize({ item: this.props.item.description });
  }
  ...
  onKeyPressHandler(e) {
    if (e.key === "Enter") {
      document.querySelector(".add-task").click(); //trigger a click on add task programatically
    }
  }
  ...
  render() {
    ...
    const form = (
      <form
        className="ui form checklist-form"
      ...
      >
        ...
        <div>
          ...
          >
            <img src="/images/icons/plus-white.svg" alt="add task" />{" "}
            {id ? "Save" : "Add"}
          </button>
