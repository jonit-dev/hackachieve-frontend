...
class Register extends Component {
  ...
  onSubmit = formValues => {
    ...
    this.props.userRegister(formValues).then(() => {
      //first register it

      if (this.props.canRedirectLogin) {
        //if everything is ok, this variable will be changed to true

        setTimeout(() => {
          this.props.userLogin({
            //login user with same information!
    ...
    return (
      <div className="field">
        ...
        {meta.touched && meta.error ? (
          <ValidationMessage message={meta.error} />
        ) : null}
      </div>
    );
  }
  ...
  render() {
    return (
      <React.Fragment>
        <Helmet>
          <title>
            Register at Hackachieve - Your Personal Goal Planner Online
          </title>
          <meta
            name="description"
            content="It's now very simple to manage and track all your goals online with Hackachieve. Sign up for free to apply smart goals in your business or personal life."
          />
        </Helmet>
          ...
          <div className="ui text container">
            ...
            >
              ...
              <Field
                ...
                validate={required}
              >
                <Link to="/terms">I agree with Hackachieve terms of use</Link>
              </Field>
