              ...
              <div className="col-md-12" style={{position: 'relative'}} data-aos="fade-up">
                <div className="row">
                  ...
                  <div className="col-lg-7">
                    <img src="landing_resources/images/landing_1.png" alt="character with goals" className="img-fluid cracter-img" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="container">
            ...
            <div className="row align-items-stretch">
              <div className="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up">
                <div className="unit-4 d-block">
                  ...
                  <div>
                    ...
                    <p>We’ll promptly notify you if some of your goals is about to expire, avoiding the headaches that a missing it could cause.</p>
              ...
              <div className="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up">
                <div className="unit-4 d-block">
                  ...
                  <div>
                    ...
                    <p>Manage your business in an engaging way: allow your teammates to earn points if certain goals are achieved and reward the best performing ones!</p>
                    {/* <p><a href="# ">Learn More</a></p> */}
                  </div>
                </div>
              </div>
              <div className="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up">
                <div className="unit-4 d-block">
                  <div className="unit-4-icon mb-3">
                    <span className="icon-wrap"><span><i className="fas fa-users" /></span></span>
                  </div>
                  <div>
                    <h3>Community-oriented platform</h3>
                    <p>We bring social to a productivity context! In our platform, you can share your goals, see a goal feed and even follow people that you admire</p>
                    {/* <p><a href="# ">Learn More</a></p> */}
                  </div>
                </div>
              </div>
              <div className="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up">
                <div className="unit-4 d-block">
                  ...
                  <div>
                    ...
                    <p>Hackachieve allows you to easily create short term and long term goals, checklists, labels, set deadlines, and etc. Everything you need to manage your own life or the daily operations of your business!</p>
        ...
        <div className="feature-big">
          <div className="container">
            <div className="row site-section" id="connect-the-dots">
              <div className="col-lg-7">
                <img src="landing_resources/images/dashboard.png" alt="dashboard illustration" className="img-fluid" />
              </div>
              <div className="col-lg-5 ml-auto">
                <h2 className="text-black">Connect the dots</h2>
                <p className="mb-4">Hackachieve helps you to “connect the dots” between your long and short term goals, doubling your productivity in half of the time! Stop losing time procastinating.</p>
                ...
                <div className="author-box">
                  <div className="d-flex mb-4">
                    <div className="mr-3">
                      <img src="landing_resources/images/person_1.jpg" alt="testimonial person" className="img-fluid rounded-circle" />
                    </div>
                    <div className="mr-auto text-black">
                      <strong className="font-weight-bold mb-0">Joao Paulo Furtado</strong> <br />
                      Full-stack developer.
                    </div>
                  </div>
                  <blockquote>“I dont know what else to say. I would be lost without Hackachieve. Man, this thing is getting better and better as I learn more about it.”</blockquote>
                </div>
              </div>
            </div>
          ...
          <div className="row">
              <div className="col-md-12">
                <p className="mb-0 copyright">
                  ...
                  Copyright © All rights reserved | This template is made with <i className="icon-heart" aria-hidden="true" /> by <a href="https://colorlib.com" target="blank">Colorlib</a>
                  {/* Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. */}
                </p>
              </div>
            </div>
