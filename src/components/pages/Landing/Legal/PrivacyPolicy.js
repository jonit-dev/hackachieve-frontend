...
the choices you have associated with that data."
        ...
        <div className="site-wrap internal-page">
          <div className="ui text container privacy">
            ...
            <p>
              Hackachieve ("us", "we", or "our") operates the{" "}
              {this.state.env.productionUrl} website (the "Service").
            </p>
            ...
            <p>
              Hackachieve will take all steps reasonably necessary to ensure
            ...
            <p>
              Hackachieve may disclose your Personal Data in the good faith
              belief that such action is necessary to:
            </p>
            <ul>
              <li>To comply with a legal obligation</li>
              <li>
                To protect and defend the rights or property of Hackachieve
              </li>
              <li>
